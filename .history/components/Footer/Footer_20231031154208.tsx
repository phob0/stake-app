        ...
        <Box>
            ...
            <VStack align='stretch' mt={5}>
                ...
                <HStack mt={10} mb={5} spacing={3}>
                    ...
                    <Button variant="link" fontSize={'90%'} sx={linkStyle}>Key Risks</Button>
                    <Button variant="link" fontSize={'90%'} sx={linkStyle}>Privacy Policy</Button>
                    <Button variant="link" fontSize={'90%'} sx={linkStyle}>Cookies Notice</Button>
                </HStack>
