        ...
        <Box>
            ...
            <VStack align='stretch' mt={5}>
                ...
                <HStack mt={10} mb={5} spacing={3}>
                    ...
                    <Button variant="link" sx={linkStyle}>Key Risks</Button>
                    <Button variant="link" sx={linkStyle}>Privacy Policy</Button>
                    <Button variant="link" sx={linkStyle}>Cookies Notice</Button>
                </HStack>
