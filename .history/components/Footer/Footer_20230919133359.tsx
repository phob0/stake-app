    ...
    return (
        <Box>
            ...
            <VStack align='stretch' mt={5}>
                ...
                <HStack mt={10} mb={5} spacing={3}>
                    <Text as='small' color="#A3ABBA">© 2023 Stake. All rights reserved</Text>
                    <Button variant="link" fontSize={'90%'} sx={linkStyle}>Terms of use</Button>
                    <Button variant="link" fontSize={'80%'} sx={linkStyle}>Key Risks</Button>
                    <Button variant="link" fontSize={'80%'} sx={linkStyle}>Privacy Policy</Button>
                    <Button variant="link" fontSize={'80%'} sx={linkStyle}>Cookies Notice</Button>
                </HStack>
